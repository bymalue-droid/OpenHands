...
- [deepseek/deepseek-v3](https://api-docs.deepseek.com/) (also supports function calling via custom API providers like Featherless)
...
<Note>
**Using Custom API Providers**: You can use custom API providers like Featherless, Together AI, or other OpenAI-compatible endpoints by setting:
- Model: The model identifier (e.g., `deepseek-ai/DeepSeek-V3-0324`)
- Base URL: The provider's API endpoint (e.g., `https://api.featherless.ai/v1`)
- API Key: Your API key from the provider

This allows you to access models through alternative providers that may offer better pricing or availability.
</Note>
